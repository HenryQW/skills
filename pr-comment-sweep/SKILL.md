...
4. State smallest proposed fix and external effects: commit, push, and thread resolution. Proceed only when request explicitly authorizes end-to-end publication or user approves all effects. Stop for conflicting feedback, unclear behavior, product choices, or scope expansion; never invent behavior.
