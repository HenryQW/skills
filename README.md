...
| `gh-pr-creation` | Creates or publishes GitHub pull requests with scoped commits, quality checks, Conventional Commit titles, fixed PR body template, and issue closure links. | `npx skills install HenryQW/skills gh-pr-creation -a codex -y` | 2026-07-02 16:28 |
