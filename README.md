...
| `fix-ci-failures` | Fixes failing GitHub or GitLab review-request CI with minimal changes, narrow verification, focused commits, and explicit pushes. | `npx skills install HenryQW/skills fix-ci-failures -a codex -y` | 2026-07-02 23:48 |
...
| `issue-to-code` | Implements a GitHub issue into a clean feature branch, runs Greptile review loops, commits, and hands off to `gh-pr-creation` after a clean pass. | `npx skills install HenryQW/skills issue-to-code -a codex -y` | 2026-07-02 19:12 |
