...
| `gh-fix-ci` | Fixes actionable GitHub PR review or CI feedback end-to-end, including commit, push, thread replies/resolution, and Copilot reviewer refresh. | `npx skills install HenryQW/skills gh-fix-ci -a codex -a claude-code -y` | 2026-05-25 09:16 |
