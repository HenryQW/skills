...
| `code-to-pr` | Runs Greptile review loops on the current issue branch, applies actionable fixes, pushes the branch, and opens a GitHub pull request. | `npx skills install HenryQW/skills code-to-pr -a codex -y` | 2026-07-02 09:39 |
...
| `issue-to-code` | Implements a GitHub issue into a clean feature branch with a minimal intentional diff, then commits and returns only the branch name. | `npx skills install HenryQW/skills issue-to-code -a codex -y` | 2026-07-02 09:39 |
