...
| `gh-fix-ci` | Fixes GitHub PR CI failures using `gh` with failed-check inspection, root-cause analysis, minimal fixes, narrow verification, focused commits, and explicit pushes. | `npx skills install HenryQW/skills gh-fix-ci -a codex -y` | 2026-07-03 00:31 |
