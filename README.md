...
| `gh-fix-ci` | Fixes GitHub PR CI failures and review feedback end-to-end using `gh`, minimal changes, narrow verification, focused commits, explicit pushes, replies, and thread resolution. | `npx skills install HenryQW/skills gh-fix-ci -a codex -y` | 2026-07-02 23:55 |
