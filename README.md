...
| `code-to-pr` | Runs Greptile review loops on the current issue branch, applies actionable fixes, pushes the branch, and opens a GitHub pull request. | `npx skills install HenryQW/skills code-to-pr -a codex -y` | 2026-07-02 11:29 |
