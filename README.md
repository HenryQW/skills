...
| `gh-fix-ci` | Fixes actionable GitHub PR review or CI feedback end-to-end, including commit, push, thread replies/resolution, and Copilot reviewer refresh. | `npx skills install HenryQW/skills gh-fix-ci -a codex -y` | 2026-05-26 18:07 |
| `gh-pr-creation` | Creates pull requests end-to-end, including scoped commits, quality checks, branch naming, PR metadata, and Copilot reviewer assignment. | `npx skills install HenryQW/skills gh-pr-creation -a codex -y` | 2026-04-03 12:42 |
